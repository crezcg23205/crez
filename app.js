...
(function () {
  ...
  const projects = [
    ...
    { 
      ...
      deliverables: ['Full Production', '3D Modeling', 'Rendering'],
    ...
    { 
      ...
      deliverables: ['Infographics', 'Motion Design', 'Data Visualization'],
    ...
    { 
      ...
      deliverables: ['Social Reel', 'VFX', 'Color Grading'],
